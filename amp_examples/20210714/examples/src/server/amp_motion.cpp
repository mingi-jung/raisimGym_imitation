...
// void quat2vec(double &q1, double &v1);
...
int main(int argc, char* argv[]) {
  ...
  /// create objects
  world.addGround();
  anymal_ = world.addArticulatedSystem(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\urdf\\MSK_GAIT2392_model_subject06.urdf");
  ...
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking12_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking12_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking12_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking12_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking13_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking13_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking13_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking13_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking14_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking14_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking14_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking14_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking15_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking15_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking15_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking15_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking16_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking16_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking16_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking16_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking17_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking17_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking17_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking17_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking18_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking18_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking18_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking18_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking19_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking19_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking19_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking19_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking20_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking20_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking20_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking20_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking21_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking21_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking21_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking21_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking22_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking22_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking22_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking22_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking23_straight01.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking23_straight02.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking23_straight03.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking23_straight04.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking10_run.txt");
  deepmimic_.add_ref_motion(binaryPath.getDirectory() + "\\rsc\\gaitmsk\\refmotion\\subject06\\subject06_walking11_run.txt");
  ...
  for (int irefmotion=0; irefmotion < deepmimic_.get_num_refmotion(); irefmotion++) {
      ...
      for (std::size_t isample=1; isample < nsample; isample++) {
          ...
          Eigen::VectorXd gc0, gc1(gcDim_), gc2(gcDim_), gv0(gvDim_), gc_mod(gvDim_-6);
          gc0.setZero(gcDim_);
          ...
          set_obDouble_from_gc(gc_mod, gc0, 0);
          // if (irefmotion==0 && isample==1){
          //   std::cout<<gc_mod<<std::endl;
          // }
          ...
          // std::cout<<"all matrix: "<<gc_endeff<<std::endl;
          // std::cout<<"element: "<<gc_endeff(1)<<std::endl;
          // std::cout<<"gc_endeff.size(): "<<gc_endeff.size()<<std::endl;
          // std::cout<<"gc_endeff.row(0)(1): "<<gc_endeff.row(0)(1)<<std::endl;
          ...
          for(int i=0; i < gc_mod.size(); i++){
            state.push_back(gc_mod[i]);
          }
          ...
          // }
          state.push_back(gc_endeff.row(0)(0));
          state.push_back(gc_endeff.row(0)(1));
          state.push_back(gc_endeff.row(0)(2));
          state.push_back(gc_endeff.row(1)(0));
          state.push_back(gc_endeff.row(1)(1));
          state.push_back(gc_endeff.row(1)(2));
          state.push_back(gc_endeff.row(2)(0));
          state.push_back(gc_endeff.row(2)(1));
          state.push_back(gc_endeff.row(2)(2));
          state.push_back(gc_endeff.row(3)(0));
          state.push_back(gc_endeff.row(3)(1));
          state.push_back(gc_endeff.row(3)(2));
          state.push_back(gc_endeff.row(4)(0));
          state.push_back(gc_endeff.row(4)(1));
          state.push_back(gc_endeff.row(4)(2));
  ...
  std::ofstream o("AMP_subject06_01.json");
