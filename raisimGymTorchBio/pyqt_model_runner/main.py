...
class App(QWidget):
    ...
    def initUI(self):
        ...
        # self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210120/2021-01-19-18-18-39/policy_8500"
        # self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210611/2021-06-10-15-25-47/policy_9950" # normal 100per
        # self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210629/2021-06-28-23-36-55/policy_9950" # normal 150per
        # self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210622/2021-06-21-17-56-41/policy_9950" # run 100per
        # self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210702/2021-07-01-20-37-09/policy_9950" # run 100per
        # self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210616/2021-06-14-18-03-26/policy_9950" # fast 100per
        self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210630/2021-06-29-22-22-54/policy_9950" # fast 150per
        ...
        self.extra_info1 = "Treadmill_Vel"
        ...
        self.extra_info3 = ""
        lineedit_controller_filepath = QLineEdit(self.extra_info3, self)
        lineedit_controller_filepath.move(100, 230)
        lineedit_controller_filepath.textChanged.connect(self.extra_info3_update)

        self.extra_info4 = ""
        lineedit_controller_filepath = QLineEdit(self.extra_info4, self)
        lineedit_controller_filepath.move(100, 270)
        lineedit_controller_filepath.textChanged.connect(self.extra_info4_update)

        button_run_raisim_env = QPushButton('Run RaisimEnv', self)
        button_run_raisim_env.setToolTip('It runs a RaisimGymVecEnv')
        button_run_raisim_env.move(100, 310)
        button_run_raisim_env.clicked.connect(self.on_click_run_raisim)

        self.data_name = ""
        lineedit_controller_filepath = QLineEdit(self.data_name, self)
        lineedit_controller_filepath.move(100, 350)
        ...
        button_save_graph.move(100, 390)
    ...
    def extra_info3_update(self, text):
        self.extra_info3 = text

    def extra_info4_update(self, text):
        self.extra_info4 = text
    ...
    def on_click_run_raisim(self):
        ...
        if self.extra_info1 != "":
            x_axis1 = list()
            y_axis1 = list()
            self.data[self.extra_info1] = []
        if self.extra_info2 != "":
            x_axis2 = list()
            y_axis2 = list()
            self.data[self.extra_info2] = []
        if self.extra_info3 != "":
            x_axis3 = list()
            y_axis3 = list()
            self.data[self.extra_info3] = []
        if self.extra_info4 != "":
            x_axis4 = list()
            y_axis4 = list()
            self.data[self.extra_info4] = []
        ...
        for step in range(max_steps):
            ...
            if self.extra_info1 != "":
                ...
                # y_axis1.append(infos[0][self.extra_info1] - infos[0][self.extra_info2])
                y_axis1.append(infos[0][self.extra_info1])
                self.data[self.extra_info1].append(float(infos[0][self.extra_info1]))

            if self.extra_info2 != "":
                x_axis2.append(step*0.01)
                y_axis2.append(infos[0][self.extra_info2])
                self.data[self.extra_info2].append(float(infos[0][self.extra_info2]))

            if self.extra_info3 != "":
                x_axis3.append(step*0.01)
                y_axis3.append(infos[0][self.extra_info3])
                self.data[self.extra_info3].append(float(infos[0][self.extra_info3]))

            if self.extra_info4 != "":
                x_axis4.append(step*0.01)
                y_axis4.append(infos[0][self.extra_info4])
                self.data[self.extra_info4].append(float(infos[0][self.extra_info4]))
        ...
        if self.extra_info3 != "":
            self.graph_draw.plot(x=x_axis3, y=y_axis3, pen=pg.mkPen('g'))
        if self.extra_info4 != "":
            self.graph_draw.plot(x=x_axis4, y=y_axis4, pen=pg.mkPen('b'))
    ...
    def on_click_save_graph(self):
        ...
        exporter.export(self.data_name + '.png')
