...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210510/2021-05-09-17-21-18/policy_9950"
        ...
        lineedit_controller_filepath.move(100, 110)
        ...
        button_save_graph.move(100, 270)
    ...
    def on_click_run_raisim(self):
        ...
        # ## real time
        # self.real_draw = self.graph_draw.plot(pen='g')
        ...
        for step in range(max_steps):
            ...
            # print(infos[0]['Reward_CoM'])
            # self.graph_draw.plot(infos[0]['Reward_CoM'])
            # self.real_draw.setData(x=step, y=infos[0]['Reward_CoM'])
            # self.real_draw.setData(x=[step], y=[1])
