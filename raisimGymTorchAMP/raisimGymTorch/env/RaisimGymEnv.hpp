...
class RaisimGymEnv {
 ...
 public:
  ...
  virtual void observe_amp(Eigen::Ref<EigenVec> ob) = 0;
  ...
  virtual void updateExtraInfo() {};   // by skoo
  ////////////////////////////////
  ...
  int getExtraInfoDim() { return extraInfo_.size(); }  // by skoo

  std::unordered_map<std::string, float> extraInfo_;   // by skoo
