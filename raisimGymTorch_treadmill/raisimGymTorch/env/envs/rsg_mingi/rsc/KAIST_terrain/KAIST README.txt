...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=KAIST&box=127.406105,36.405314,127.316813,36.333449
...
-----------
  ...
  * KAIST Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * KAIST Height Map (SRTM3 v4.1).png
  ...
  * KAIST Height Map (SRTM30 Plus).png
