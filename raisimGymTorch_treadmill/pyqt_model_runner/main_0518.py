...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.controller_weight_filepath = "/home/opensim2020/Desktop/pytorch_result/20210514/2021-05-13-10-08-56/policy_9950"
        ...
        self.image_name = ""
        lineedit_controller_filepath = QLineEdit(self.image_name, self)
        lineedit_controller_filepath.move(100, 270)
        lineedit_controller_filepath.textChanged.connect(self.image_name_update)
        ...
        button_view_diff = QPushButton('view diff', self)
        button_view_diff.setToolTip('It views diff as a value')
        button_view_diff.move(100, 350)
        button_view_diff.clicked.connect(self.on_click_view_diff)
    ...
    def image_name_update(self, text):
    ...
    @pyqtSlot()
    def on_click_view_diff(self):
        print('on_click_view_diff ...... ', end='')

        diff = [(x-y)**2 for x, y in zip(self.extra_info_value1, self.extra_info_value2)]
        RMS = sum(diff)/len(self.extra_info_value1)
        RMS = RMS**0.5
        print(RMS)
